...
//*************************************** True b-jets ***************************************
  ...
  TTree * Tree = new TTree{"Tree","mc_pt:rec_pt"};
...
// ***********************************************************************************
  ...
  TBranch* mc_pt1 = Tree -> Branch("mc_pt",&ptb1_True);
  TBranch* mc_pt2 = Tree -> Branch("mc_pt",&ptb2_True);
...
Tree->Fill();
  ...
  // first = ptb1_True;
  // Int_t first;
  // mc_pt -> SetAddress(&ptb1_True);
  // mc_pt -> Fill();
  // mc_pt -> SetAddress(&ptb2_True);
 }

  TBranch* rec_pt = Tree -> Branch("rec_pt",&pt_rec);
