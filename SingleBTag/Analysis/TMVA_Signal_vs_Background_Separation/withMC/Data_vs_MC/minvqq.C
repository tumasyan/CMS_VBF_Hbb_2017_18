...
//***************************************************************************************
  ...
  TH1D * _MINVQQ_VBF_Hbb  = new TH1D("MINVQQ_VBF_Hbb","MINVQQ_VBF_Hbb",nbin,xmin,xmax);
  TH1D * _MINVQQ_ggF_Hbb  = new TH1D("MINVQQ_ggF_Hbb","MINVQQ_ggF_Hbb",nbin,xmin,xmax);
  TH1D * _MINVQQ_QCD  = new TH1D("MINVQQ_QCD","MINVQQ_QCD",nbin,xmin,xmax);
  TH1D * _MINVQQ_Single_Top  = new TH1D("MINVQQ_Single_Top","MINVQQ_Single_Top",nbin,xmin,xmax);
  TH1D * _MINVQQ_tt  = new TH1D("MINVQQ_tt","MINVQQ_tt",nbin,xmin,xmax);
  TH1D * _MINVQQ_WJets  = new TH1D("MINVQQ_WJets","MINVQQ_WJets",nbin,xmin,xmax);
  TH1D * _MINVQQ_ZJets  = new TH1D("MINVQQ_ZJets","MINVQQ_ZJets",nbin,xmin,xmax);
  TH1D * _MINVQQ_DYJets = new TH1D("MINVQQ_DYJets","MINVQQ_DYJets",nbin,xmin,xmax);
  TH1D * _MINVQQ_DATA   = new TH1D("MINVQQ_DATA","MINVQQ_DATA",nbin,xmin,xmax);
//***************************************************************************************
