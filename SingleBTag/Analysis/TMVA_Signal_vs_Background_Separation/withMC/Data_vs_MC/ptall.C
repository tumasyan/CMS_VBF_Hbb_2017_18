...
//***************************************************************************************
  ...
  TH1D * _PTALL_VBF_Hbb  = new TH1D("PTALL_VBF_Hbb","PTALL_VBF_Hbb",100,xmin,xmax);
  TH1D * _PTALL_ggF_Hbb  = new TH1D("PTALL_ggF_Hbb","PTALL_ggF_Hbb",100,xmin,xmax);
  TH1D * _PTALL_QCD  = new TH1D("PTALL_QCD","PTALL_QCD",100,xmin,xmax);
  TH1D * _PTALL_Single_Top  = new TH1D("PTALL_Single_Top","PTALL_Single_Top",100,xmin,xmax);
  TH1D * _PTALL_tt  = new TH1D("PTALL_tt","PTALL_tt",100,xmin,xmax);
  TH1D * _PTALL_WJets  = new TH1D("PTALL_WJets","PTALL_WJets",100,xmin,xmax);
  TH1D * _PTALL_ZJets  = new TH1D("PTALL_ZJets","PTALL_ZJets",100,xmin,xmax);
  TH1D * _PTALL_DYJets = new TH1D("PTALL_DYJets","PTALL_DYJets",100,xmin,xmax);
  TH1D * _PTALL_DATA   = new TH1D("PTALL_DATA","PTALL_DATA",100,xmin,xmax);
//***************************************************************************************
