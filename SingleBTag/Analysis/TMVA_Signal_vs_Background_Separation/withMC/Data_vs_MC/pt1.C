...
//***************************************************************************************
  TFile *f = new TFile("PT1_Output.root","RECREATE");
  gStyle->SetOptFile(0);
  ...
  TH1D * _PT1_VBF_Hbb  = new TH1D("PT1_VBF_Hbb","PT1_VBF_Hbb",nbin,xmin,xmax);
  TH1D * _PT1_ggF_Hbb  = new TH1D("PT1_ggF_Hbb","PT1_ggF_Hbb",nbin,xmin,xmax);
  TH1D * _PT1_QCD  = new TH1D("PT1_QCD","PT1_QCD",nbin,xmin,xmax);
  TH1D * _PT1_Single_Top  = new TH1D("PT1_Single_Top","PT1_Single_Top",nbin,xmin,xmax);
  TH1D * _PT1_tt  = new TH1D("PT1_tt","PT1_tt",nbin,xmin,xmax);
  TH1D * _PT1_WJets  = new TH1D("PT1_WJets","PT1_WJets",nbin,xmin,xmax);
  TH1D * _PT1_ZJets  = new TH1D("PT1_ZJets","PT1_ZJets",nbin,xmin,xmax);
  TH1D * _PT1_DYJets = new TH1D("PT1_DYJets","PT1_DYJets",nbin,xmin,xmax);
  TH1D * _PT1_DATA   = new TH1D("PT1_DATA","PT1_DATA",nbin,xmin,xmax);
//***************************************************************************************
   ...
   for(int i=0;i<ntps[k]->GetEntries();i++)
    {
     ...
     if(k==0)
      _PT1_VBF_Hbb->Fill(MyS_pt1[k],MyS_weight[k]);
     if(k==1)
      _PT1_ggF_Hbb->Fill(MyS_pt1[k],MyS_weight[k]);
    }
   ...
   for(int i=0;i<ntpb[k]->GetEntries();i++)
    {
     ...
     if(k<7)
      _PT1_QCD->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k>=7 && k<11)
      _PT1_Single_Top->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k>=11 && k<14)
      _PT1_tt->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k>=14 && k<16)
      _PT1_WJets->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k>=16 && k<19)
      _PT1_ZJets->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k==19)
      _PT1_DYJets->Fill(MyB_pt1[k],MyB_weight[k]);
     else if(k==20)
      _PT1_DATA->Fill(MyB_pt1[k],MyB_weight[k]);
    }
