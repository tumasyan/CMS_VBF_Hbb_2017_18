...
//***************************************************************************************
  TFile *f = new TFile("BTG2_Output.root","RECREATE");
  gStyle->SetOptFile(0);
  ...
  TH1D * _BTG2_VBF_Hbb  = new TH1D("BTG2_VBF_Hbb","BTG2_VBF_Hbb",100,xmin,xmax);
  TH1D * _BTG2_ggF_Hbb  = new TH1D("BTG2_ggF_Hbb","BTG2_ggF_Hbb",100,xmin,xmax);
  TH1D * _BTG2_QCD  = new TH1D("BTG2_QCD","BTG2_QCD",100,xmin,xmax);
  TH1D * _BTG2_Single_Top  = new TH1D("BTG2_Single_Top","BTG2_Single_Top",100,xmin,xmax);
  TH1D * _BTG2_tt  = new TH1D("BTG2_tt","BTG2_tt",100,xmin,xmax);
  TH1D * _BTG2_WJets  = new TH1D("BTG2_WJets","BTG2_WJets",100,xmin,xmax);
  TH1D * _BTG2_ZJets  = new TH1D("BTG2_ZJets","BTG2_ZJets",100,xmin,xmax);
  TH1D * _BTG2_DYJets = new TH1D("BTG2_DYJets","BTG2_DYJets",100,xmin,xmax);
  TH1D * _BTG2_DATA   = new TH1D("BTG2_DATA","BTG2_DATA",100,xmin,xmax);
//***************************************************************************************
   ...
   for(int i=0;i<ntps[k]->GetEntries();i++)
    {
     ntps[k]->GetEntry(i);
     if(k==0)
      _BTG2_VBF_Hbb->Fill(MyS_btgb2_D[k],MyS_weight[k]);
     if(k==1)
      _BTG2_ggF_Hbb->Fill(MyS_btgb2_D[k],MyS_weight[k]);
    }
   ...
   for(int i=0;i<ntpb[k]->GetEntries();i++)
    {
     ntpb[k]->GetEntry(i);
     if(k<7)
      _BTG2_QCD->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k>=7 && k<11)
      _BTG2_Single_Top->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k>=11 && k<14)
      _BTG2_tt->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k>=14 && k<16)
      _BTG2_WJets->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k>=16 && k<19)
      _BTG2_ZJets->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k==19)
      _BTG2_DYJets->Fill(MyB_btgb2_D[k],MyB_weight[k]);
     else if(k==20)
      _BTG2_DATA->Fill(MyB_btgb2_D[k],MyB_weight[k]);
    }
