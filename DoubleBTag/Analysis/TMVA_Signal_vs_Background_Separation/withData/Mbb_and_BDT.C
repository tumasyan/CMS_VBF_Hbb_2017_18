...
//***************************************************************************************
  TFile *f = new TFile("mbb_and_BDT.root","RECREATE");
  gStyle->SetOptFile(0);
  gStyle->SetOptStat("mre");
  gStyle->SetPaintTextFormat("1.2e");
  TNtuple *_MinvS0 = new TNtuple("MinvS0","MinvS0","weight:mbb:bdtout");
  TNtuple *_MinvS1 = new TNtuple("MinvS1","MinvS1","weight:mbb:bdtout");
  TNtuple *_MinvB  = new TNtuple("MinvB","MinvB","weight:mbb:bdtout");
  TNtuple *_MinvO  = new TNtuple("MinvO","MinvO","weight:mbb:bdtout");
   ...
   for(int i=0;i<ntps0->GetEntries();i++)
    {
     ...
     minvbb       = My_minvbb;
    _MinvS0->Fill(My_weight,minvbb,reader->EvaluateMVA("TMVAClassification_BDTG"));
    }
   ...
   for(int i=0;i<ntps1->GetEntries();i++)
    {
     ...
     minvbb   = MyS1_minvbb;
    _MinvS1->Fill(MyS1_weight,minvbb,reader->EvaluateMVA("TMVAClassification_BDTG"));
    }
   ...
   for(int i=0;i<ntpb->GetEntries();i++)
    {
     ...
     minvbb   = MyB_minvbb;
    _MinvB->Fill(MyB_weight,minvbb,reader->EvaluateMVA("TMVAClassification_BDTG"));
    }
   ...
   for(int i=0;i<ntpo->GetEntries();i++)
    {
     ...
     minvbb   = MyO_minvbb;
    _MinvO->Fill(MyO_weight,minvbb,reader->EvaluateMVA("TMVAClassification_BDTG"));
    }
  f->Write();
  delete f1;
}
