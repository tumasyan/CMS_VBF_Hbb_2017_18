...
//***************************************************************************************
  ...
  TH1D * _DETAQQ_VBF_Hbb  = new TH1D("DETAQQ_VBF_Hbb","DETAQQ_VBF_Hbb",100,xmin,xmax);
  TH1D * _DETAQQ_ggF_Hbb  = new TH1D("DETAQQ_ggF_Hbb","DETAQQ_ggF_Hbb",100,xmin,xmax);
  TH1D * _DETAQQ_QCD  = new TH1D("DETAQQ_QCD","DETAQQ_QCD",100,xmin,xmax);
  TH1D * _DETAQQ_Single_Top  = new TH1D("DETAQQ_Single_Top","DETAQQ_Single_Top",100,xmin,xmax);
  TH1D * _DETAQQ_tt  = new TH1D("DETAQQ_tt","DETAQQ_tt",100,xmin,xmax);
  TH1D * _DETAQQ_WJets  = new TH1D("DETAQQ_WJets","DETAQQ_WJets",100,xmin,xmax);
  TH1D * _DETAQQ_ZJets  = new TH1D("DETAQQ_ZJets","DETAQQ_ZJets",100,xmin,xmax);
  TH1D * _DETAQQ_DYJets = new TH1D("DETAQQ_DYJets","DETAQQ_DYJets",100,xmin,xmax);
  TH1D * _DETAQQ_DATA   = new TH1D("DETAQQ_DATA","DETAQQ_DATA",100,xmin,xmax);
//***************************************************************************************
